...
public class KeylessTest extends AVelvetTxnTest {
    ...
    public void testGetAll() {
        List<Integer> all = Stream.of(ENTITY.batchGetAll(velvet).values()).map(KeylessEnt::getNum).collect(Collectors.toList());
    ...
    public void testTraverse() {
        ...
        List<Integer> order = Stream.of(ENTITY.batchGetAll(velvet).values()).map(KeylessEnt::getNum).collect(Collectors.toList());
