...
import com.zakgof.db.velvet.entity.MultiLinkDef;
...
public class IndexedMultiLinkDef<HK, HV, CK, CV, C extends Comparable<C>> extends MultiLinkDef<HK, HV, CK, CV> implements IIndexedMultiGetter<HK, HV, CK, CV, C> {
  ...
  public IndexedMultiLinkDef(IEntityDef<HK, HV> hostEntity, IEntityDef<CK, CV> childEntity, String edgeKind, Function<CV, C> metric) {
